...
#     if [[ $? -eq 0 ]]
#     then
#         echo "Successfully configured your environment with bechelani's macOS dotfiles..."
#     else
#         echo "bechelani's macOS dotfiles were not applied successfully..." >&2
# fi
# else
# 	echo ''
#     echo "You chose not to apply bechelani's macOS dotfiles. You will need to configure your environment manually..."
# 	echo ''
