...
export PATH=/usr/local/bin:/usr/bin:/bin:/usr/sbin:/sbin:/Users/Michel/.dnx/runtimes/dnx-mono.1.0.0-rc1-update1/bin:/Users/Michel/.dnx/bin:$PATH # Reorder PATH so local bin is first
...
# DotNet {{{
# Load dnvm
[ -s "/Users/Michel/.dnx/dnvm/dnvm.sh" ] && . "/Users/Michel/.dnx/dnvm/dnvm.sh"
