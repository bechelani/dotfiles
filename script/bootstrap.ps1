...
function SetupGitConfig() {
    if ((Test-Path -Path $DOTFILES_ROOT\git\gitconfig.local.symlink -PathType Leaf) -eq $false) {
...
function SetupPowerShellSymLinks() {
    ...
    LinkFile -Source (Join-Path $DOTFILES_ROOT "powershell\Microsoft.PowerShell_profile.ps1.symlink") -Destination $Profile # $HOME\.config\PowerShell\Microsoft.PowerShell_profile.ps1
